...
> **【2026-09-14】** 本事象の修正を確認しました。詳細は末尾の「補足」をご確認ください。
...
**【2026-09-14 追記】** 本事象の修正を確認しました。

本日時点で利用可能な環境であらためてSlack連携を試しました。
今回新設されたワンクリック設定手順で、Slackワークスペースへの接続・アプリの追加が正常に完了し、Slack上からエージェントと問題なくチャットできることを確認しました。
本スクリプトの提供は当面継続した後、適宜提供を終了する予定です。
